...
#### 08.03
I tried to do the animation of the space growing big. The Unity Timeline is very weird, and the beginning parameters always jumped very randomly, and I couldn't find the reason why my parameters are jumping in ways I don't want them to jump. I tried to google the problem, I found that other people are also stressed about Timeline in general. I started to code the animations, as in theory it is not too complicated as it is just the position and the scale of my gameobjects, and that part was almost ok, but I also wanted to have different speed in the change of the animations, and I needed to understand how time is working in unity, but I got very confused by the documentation. 
So I wanted to give another time for the timeline, because it worked in the tower scene. I found the very non-logical trick to work with: don't give the starting parameter first, which is in my case usually the original parameter of the room, but start with the third parameter, and give the first parameter last. Somehow this way the parameters didn't jump, and I could achive what I wanted, but I don't think that this is how logic works.
A friend tried the experience in VR, he said my new gummybear wallpaper solution is boring, and the old one is more interesting visually, which I agree with, but the right scale is more important than the amusement in a way. But maybe i shouldn't think this. I haven't talked to Miklós for a while, because I wanted to see how things are working in VR, but this would be the time to ask his opinion again. 
I finished the animation of the space growing scene for now. 
My friend also showed me the buttons I couldnt find in Ableton, so I could add my spatial affects on my voiceover. It is weird how different things sound with headphones and without, I like it more how they sound without them, and I think thats closer to how I hear things in the oculus. On the basic space there is just a spatial effect, hopefully it gives some transcendence to my voice. When it grows to a tower, it has a church effect, when it is small it has the small room effect. And I tried to make the effects appear when the animations appear. I put the buttons here, so I dont forget them.
...
I've been thinking how to do the breakup scene, and I first wanted to make the animation from the small scene to the last scene, and by accident I've put myself outside of the space, and I realised that it is a perfect way to shut out the viewer. I tried some particle systems for the final breakup, but I might have made a mistake in the image of the particles and they are big moving cubes, which is interesting, but it is more happening than anything else in the whole experience, so it is not ideal. 
I also realised that something was weird with the volume of the sound that i recorded yesterday, so i made the sound again in ableton. 
I wasn't sure if i want to use any music now, but I found another Brian Eno song (called New Space Music (!) https://www.youtube.com/watch?v=-dikWB6wm0A) which is even more neutral than the previous one, which didn't fit fully, so I gve it a try, and I think it helps to be more engaged and less bored in the space. I also tried to be better with the sound effects, well, it's not perfect yet, it slightly feels like I just found the sound effect buttons and used them (although there are A LOT OF effects in ableton, so finding the right ones is already something). It's not bad, it's not amazing.
...
These also seemed like as not unuseful articles.
