...
I also started to think that maybe I should just paint the mesh of them and put them on my cubes, I knew how to use a software for this a few years ago, but I forgot. So my mind is jumping from one idea to another one now, which is not the best method to work by the way. But here are some creepy gummybear pictures.
